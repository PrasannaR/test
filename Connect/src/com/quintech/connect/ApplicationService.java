...
//		        t2.start();
	...
	private void createUpdateConfigurationAlarm()
	{
		try
		{
			...
			LocalBroadcastManager.getInstance(Constants.applicationContext).registerReceiver(mAlarmReceiver,
  				      new IntentFilter(Action.UPDATE_ALARM));
	...
	private OnAlarmReceiver mAlarmReceiver = new OnAlarmReceiver();
