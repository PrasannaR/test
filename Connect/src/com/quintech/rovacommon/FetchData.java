...
public class FetchData 
{
	...
	public PIMSettingsInfo getPIMSettings()
	{
		...
		PIMSettings.bShareCalendar = Constants.getData().getFlag(Flags.FLG_ShareCalendar, Data.SafeSpace);
		PIMSettings.bShareContact = Constants.getData().getFlag(Flags.FLG_ShareContact, Data.SafeSpace);
			
		//ProxySettings
		PIMSettings.bisProxyBasedRoutingEnabled = Constants.getData().getFlag(Flags.FLG_ProxyBasedRoutingEnabled, Data.SafeSpace);
		PIMSettings.bProxyHTTPS= Constants.getData().getFlag(Flags.FLG_ProxyHTTPS, Data.SafeSpace);
		PIMSettings.bProxyHTTP= Constants.getData().getFlag(Flags.FLG_ProxyHTTP, Data.SafeSpace);
		PIMSettings.bProxyUDP= Constants.getData().getFlag(Flags.FLG_ProxyUDP, Data.SafeSpace);
		PIMSettings.bProxyTCP= Constants.getData().getFlag(Flags.FLG_ProxyTCP, Data.SafeSpace);
		}
		catch (Exception e)
		{
	...
	public BrowserSettingsInfo getBrowserSettings() {
		BrowserSettingsInfo browsersettings = new BrowserSettingsInfo();
		
	    browsersettings.BlackWhite = Constants.getData().getSetting(Settings.SET_BrowserBlackWhite, Data.SafeSpace);

	    browsersettings.CookiesBlocked = Constants.getData().getFlag(Flags.FLG_CookiesBlocked, Data.SafeSpace);
	    browsersettings.FileDownloadBlocked = Constants.getData().getFlag(Flags.FLG_FileDownloadBlocked, Data.SafeSpace);
	    browsersettings.PrintingBlocked = Constants.getData().getFlag(Flags.FLG_PrintingBlocked, Data.SafeSpace);
	    browsersettings.CopyPasteBlocked = Constants.getData().getFlag(Flags.FLG_BrowserCopyPasteBlocked, Data.SafeSpace);
	    
	    browsersettings.BlockedMessage = Constants.getData().getSetting(Settings.SET_BlockedMessage, Data.SafeSpace);
	    browsersettings.HomePageURL = Constants.getData().getSetting(Settings.SET_HomePageURL, Data.SafeSpace);
