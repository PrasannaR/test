...
public class PIMSettingsInfo 
{
	...
	public Boolean bShareContact;
	public Boolean bShareCalendar;
	
	//Proxy enabled
	public Boolean bisProxyBasedRoutingEnabled;
	public Boolean bProxyHTTPS;
	public Boolean bProxyHTTP;
	public Boolean bProxyUDP;
	public Boolean bProxyTCP;
}
