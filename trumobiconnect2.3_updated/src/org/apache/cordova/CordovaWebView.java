...
import com.cognizant.trumobi.securebrowser.SB_DownloadFile;
...
public class CordovaWebView extends WebView implements OnTouchListener{
    ...
    public void loadUrlIntoView(final String url) {
        ...
        final int loadUrlTimeoutValue = Integer.parseInt(this.getProperty("loadUrlTimeoutValue", "60000"));
        ...
        final Runnable loadError = new Runnable() {
            public void run() {
                ...
                if (viewClient != null) {
                	...
                	me.loadUrl("file:///android_asset/www/error.html?unabletoconnect");
                }
            }
        };
    ...
    public boolean startOfHistory()
    {
        ...
        LOG.d(TAG, "The current URL on CTS is: " + currentUrl);
    ...
    protected void onCreateContextMenu(ContextMenu menu) {
        ...
        MenuItem.OnMenuItemClickListener handler = new MenuItem.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
            	HitTestResult result = getHitTestResult();
                    // do the menu action
            	Log.d("Content Disposition", "Item clicked:" + item.getItemId());
            	switch(item.getItemId()){
            	case 0:
            		Log.d("Content Disposition", "Item clicked:" + item.getItemId() + "URL:" + result.getExtra() + "value:" );
            		new SB_DownloadFile(cordova.getActivity().getApplicationContext()).execute(result.getExtra());
            		break;
            	case 2:
            		Log.d("Content Disposition", "Item clicked:" + item.getItemId() + "URL:" + result.getExtra() + "value:" );
            		new SB_DownloadFile(cordova.getActivity().getApplicationContext()).execute(result.getExtra());
