 ...
 *      </plugins>
 */
public class DroidGap extends TruMobiBaseActivity implements CordovaInterface {
    ...
    protected int loadUrlTimeoutValue = 60000;
            ...
            me.runOnUiThread(new Runnable() {
                public void run() {
                    if (exit) {
                    	...
                    	// for url is not correct ex:flipkart.com
                        me.appView.loadUrl("file:///android_asset/www/error.html?unabletoconnect");
                    }
                }
            });
        }
