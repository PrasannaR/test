...
class PersonaResizeViewHandler extends View {

    public PersonaResizeViewHandler(Context context) {
        super(context);
    }
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                resources.getDrawable(R.drawable.pr_camera_crop_width);
        mResizeDrawableHeight =
                resources.getDrawable(R.drawable.pr_camera_crop_height);
        mResizeDrawableDiagonal =
                resources.getDrawable(R.drawable.pr_indicator_autocrop);
    }
