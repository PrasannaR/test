...
public class PersonaCustomShirtcutActivity extends Activity implements OnClickListener {
	private static final String ACTION_ADW_PICK_ICON="com.cognizant.trumobi.icons.ACTION_PICK_ICON";
	public static final String ACTION_LAUNCHERACTION = "com.cognizant.trumobi.action.launcheraction";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (intent != null && intent.getAction() != null && intent.getAction().equals(ACTION_LAUNCHERACTION)) {
			PersonaLauncherActions.getInstance().launch(intent);
			finish();
		}

		setContentView(R.layout.pr_custom_shirtcuts);
	...
	private PersonaApplicationInfo getAppInfo() {
		...
		if (intent != null && intent.getAction() != null &&
			...
			return PersonaLauncherModel.loadApplicationInfoById(this, id);
		}
		return null;
	}

	private void loadFromAppInfo(PersonaApplicationInfo info) {
		if (info == null)
			return;
		...
		if (component != null) {
			if (component.getClassName().equals(PersonaCustomShirtcutActivity.class.getName()) &&
		...
		if(resultCode==RESULT_OK){
			...
			case PICK_CUSTOM_PICTURE:
				...
				if(mBitmap!=null){
					if(mBitmap.getWidth()>mIconSize)
						mBitmap=PersonaUtilities.createBitmapThumbnail(mBitmap, this);
					btPickIcon.setImageBitmap(mBitmap);
				}
				break;
			case PICK_CUSTOM_ICON:
				...
				try {
					...
					if(mBitmap!=null){
						if(mBitmap.getWidth()>mIconSize)mBitmap=PersonaUtilities.createBitmapThumbnail(mBitmap, this);
						btPickIcon.setImageBitmap(mBitmap);
					}
				} catch (Exception e) {
					e.printStackTrace();
			...
			case PICK_STANDARD_MENU:
		        ...
		        if (applicationName != null && applicationName.equals(shortcutName)) {
		        	...
		        	picker.setClass(this, PersonaActivityPickerActivity.class);
		        	...
		        	final ListAdapter adapter = PersonaLauncherActions.getInstance().getSelectActionAdapter();
		        	builder.setAdapter(adapter, new Dialog.OnClickListener() {
								@Override
								public void onClick(DialogInterface dialog, int which) {
									PersonaLauncherActions.Action action = (PersonaLauncherActions.Action)adapter.getItem(which);
							        ...
							        iconResource.packageName = PersonaCustomShirtcutActivity.this.getPackageName();
	...
	public void onClick(View v) {
		...
		if(v.equals(btPickActivity)){
	        ...
	        shortcutIcons.add(ShortcutIconResource.fromContext(PersonaCustomShirtcutActivity.this,
    ...
    protected class IconTypeDialog implements DialogInterface.OnClickListener,
		...
		Dialog createDialog() {
		    mAdapter = new ArrayAdapter<String>(PersonaCustomShirtcutActivity.this, R.layout.pr_add_list_item);
		    ...
		    final AlertDialog.Builder builder = new AlertDialog.Builder(PersonaCustomShirtcutActivity.this);
