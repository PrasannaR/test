...
public class CalendarPinnedHeaderListView extends ListView implements
		OnScrollListener {
	...
	public CalendarPinnedHeaderListView(Context context) {
		super(context);
		super.setOnScrollListener(this);
	}

	public CalendarPinnedHeaderListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		super.setOnScrollListener(this);
	}
	...
	public void setOnItemClickListener(
			CalendarPinnedHeaderListView.OnItemClickListener listener) {
	...
	public static abstract class OnItemClickListener implements
		...
		public void onItemClick(AdapterView<?> adapterView, View view,
			...
			CalendarSectionedBaseAdapter adapter;
			if (adapterView.getAdapter().getClass()
				...
				HeaderViewListAdapter wrapperAdapter = (HeaderViewListAdapter) adapterView
						.getAdapter();
				adapter = (CalendarSectionedBaseAdapter) wrapperAdapter
						.getWrappedAdapter();
			} else {
				adapter = (CalendarSectionedBaseAdapter) adapterView
						.getAdapter();
			}
