...
import com.cognizant.trumobi.persona.widgets.PersonaWidgetCellLayout;
...
public class PersonaCellLayout extends PersonaWidgetCellLayout {
	...
	public PersonaCellLayout(Context context) {
		this(context, null);
	}

	public PersonaCellLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PersonaCellLayout(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CellLayout, defStyle, 0);

		mCellWidth = a.getDimensionPixelSize(R.styleable.CellLayout_cellWidth, 10);
		mCellHeight = a.getDimensionPixelSize(R.styleable.CellLayout_cellHeight, 10);
		if(PersonaAlmostNexusSettingsHelper.getmainDockStyle(context)!=PersonaLauncher.DOCK_STYLE_NONE){
		...
		mRows=PersonaAlmostNexusSettingsHelper.getDesktopRows(context);
		mColumns=PersonaAlmostNexusSettingsHelper.getDesktopColumns(context);
		...
		mDesktopCacheType=PersonaAlmostNexusSettingsHelper.getScreenCache(context);
	}
	...
	//ADW: make dispatchDraw available to PersonaLauncher for creating previews
	@Override
	 ...
	 */
	 CellInfo findAllVacantCellsFromOccupied(boolean[][] occupied,
		 ...
		 //Every time you longpress an item it does the findVacantCell millions of times
	 ...
	 protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		 ...
		 if (widthSpecMode == MeasureSpec.UNSPECIFIED || heightSpecMode == MeasureSpec.UNSPECIFIED) {
			 throw new RuntimeException("PersonaCellLayout cannot have UNSPECIFIED dimensions");
		 }
		 ...
		 int topExtra=0;
		 if(PersonaAlmostNexusSettingsHelper.getDesktopIndicator(getContext()) && PersonaAlmostNexusSettingsHelper.getDesktopIndicatorType(getContext())==PersonaDesktopIndicator.INDICATOR_TYPE_PAGER){
		 ...
		 if(PersonaAlmostNexusSettingsHelper.getAutosizeIcons(getContext())){
			 mCellWidth=tmpCellW;
		 ...
		 for (int i = 0; i < count; i++) {
			 ...
			 if (mPortrait) {
				 lp.setup(cellWidth, cellHeight, mWidthGap, mHeightGap, shortAxisStartPadding,
						 longAxisStartPadding,PersonaAlmostNexusSettingsHelper.getAutosizeIcons(getContext()));
			 } else {
				 lp.setup(cellWidth, cellHeight, mWidthGap, mHeightGap, longAxisStartPadding,
						 shortAxisStartPadding,PersonaAlmostNexusSettingsHelper.getAutosizeIcons(getContext()));
			 }
	 ...
	 private void findOccupiedCells(int xCount, int yCount, boolean[][] occupied, View ignoreView) {
		 ...
		 for (int i = 0; i < count; i++) {
			 View child = getChildAt(i);
			 if (child instanceof PersonaFolder || child.equals(ignoreView)) {
				 continue;
			 }
			 LayoutParams lp = (LayoutParams) child.getLayoutParams();
	 ...
	 public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
		 return new PersonaCellLayout.LayoutParams(getContext(), attrs);
	 }

	 @Override
	 protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
		 return p instanceof PersonaCellLayout.LayoutParams;
	 }

	 @Override
	 protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
		 return new PersonaCellLayout.LayoutParams(p);
	 }
	 ...
	 static final class CellInfo implements ContextMenu.ContextMenuInfo {
		 ...
		 void findVacantCellsFromOccupied(boolean[] occupied, int xCount, int yCount) {
			 ...
			 PersonaCellLayout.findIntersectingVacantCells(this, cellX, cellY, xCount, yCount, unflattened);
		 }
