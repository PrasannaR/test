...
public class PersonaConstants {
	...
	public static final String CERT_REQUEST_ID="certificate_request_id";
	...
	public static final String STR_TABLET = "Tablets";
	public static final String STR_PHONE = "Phones";
	...
	public static final int AUTH_TYPE_PASSWORD_ALLOW_NUMERALS = 4;
	...
	public static final int BUGSENSE_ON_ALERT = 10;
	...
	// Dummy DB 
		public static final String AUTHENTICATION_TYPE_NUMERIC_STRING = "N1";
		public static final String AUTHENTICATION_TYPE_ALPHABETS_STRING = "A1";
		public static final String AUTHENTICATION_TYPE_ALPHANUMERIC_STRING = "A2";
		public static final String AUTHENTICATION_TYPE_PASSWORD_ALLOW_NUMERALS_STRING = "A3";
	
		public static final String PIN_SAVED = "Y1";
		public static final String PIN_NOT_SAVED = "N0";
	...
	//BugSense
	public static final String ROVA_BUGSENSE_CODE = "cc2185e6";
	public static final String BYOD_BUGSENSE_CODE = "ec1c53bb";
	public static final String ROVA_BUILD_TYPE = "Verizon";
	public static final String BYOD_BUILD_TYPE = "BYOD";
	
	//putExtra strings
		public static final String IS_BUGSENSE_ON = "is_bugsense_on";
	...
	public static final String CERTIFICATE_ENABLED="isCertificateEnabled";
	
	public static final int appCrashNotificationId=9999;
