...
/**
 * 
 * @author rudhra KeyCode 				Author			 Date 			Desc
 * 				 1 						290778 			16/10/13 		clear edittext string on incorrect pin 
 * 				 2 						290778 			5/11/13 		Resolved Request focus
 *         issues
 */
...
Button clearButtonalpha;
	...
	public void setQuertyKeyBoard(boolean b) {
	...
	public void setEdit(EditText edt) {
		// TODO Auto-generated method stub
		edtText = edt;
...
//
	...
	private void capitalAlphabits() {
		...
		for (int i = 0; i < idsList.size(); i++) {
			...
			btn.setTextAppearance(mcontext, R.style.personaLargeBoldFontStyle);
			//btn.setTextSize(TypedValue.COMPLEX_UNIT_DIP,20);
		}
	}

	private void smallAlphabits() {
	...
	private void numberslAlphabits() {
