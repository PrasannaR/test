 ...
 * 
 */
public class PersonaWidgetCursorAdapter extends CursorAdapter {
     ...
     * @param listViewId
     */
    public PersonaWidgetCursorAdapter(Activity a, Context context, Cursor c, Intent intent,
    ...
    public static Cursor queryForNewContent(Activity a, ContentResolver cr, Intent intent) {
        ...
        if ((intent != null) && (a != null)) {
            cursor = a.managedQuery(Uri.parse(intent
                    .getStringExtra(PersonaLauncherIntent.Extra.Scroll.EXTRA_DATA_URI)), intent
                    .getStringArrayExtra(PersonaLauncherIntent.Extra.Scroll.EXTRA_PROJECTION), intent
                    .getStringExtra(PersonaLauncherIntent.Extra.Scroll.EXTRA_SELECTION), intent
                    .getStringArrayExtra(PersonaLauncherIntent.Extra.Scroll.EXTRA_SELECTION_ARGUMENTS),
                    intent.getStringExtra(PersonaLauncherIntent.Extra.Scroll.EXTRA_SORT_ORDER));

            if (cursor != null)
                cursor.setNotificationUri(cr, Uri.parse(intent
                        .getStringExtra(PersonaLauncherIntent.Extra.Scroll.EXTRA_DATA_URI)));
            else
                PersonaLog.d(LOG_TAG, "cursor null");

        } else {
            PersonaLog.d(LOG_TAG, "intent or activity null");
        }
    ...
    //
    // PersonaLog.i(LOG_TAG, "onContentChanged");
    //
    ...
    // mIntent);
    // if (newCursor != null) {
    // PersonaLog.i(LOG_TAG, "newCursor = " + newCursor + " / count = " +
    // newCursor.getCount());
    ...
    //
    // } else {
    // PersonaLog.v(LOG_TAG, "cursor closed or null");
    // }
    // }
