...
public class PersonaBoundRemoteViews extends PersonaSimpleRemoteViews {
	...
	class CursorCache {
		...
		public CursorCache(Cursor cursor, Context context) {
			...
			final ArrayList<Action> actions = PersonaBoundRemoteViews.this.mActions;
	...
	protected class BindingAction extends PersonaSimpleRemoteViews.ReflectionAction
	{
        ...
        private class BoundOnClickListener implements OnClickListener {
        	...
        	public void onClick(View v) {
                ...
                try {
                   ...
                   PersonaLog.e("SetOnClickPendingIntent", "Cannot send pending intent: ", e);
                }
            }
	...
	public PersonaBoundRemoteViews(Parcel parcel) {
		super(parcel);
	}

	public PersonaBoundRemoteViews(int layoutId) {
		super(layoutId);
	}
	...
	protected Action loadActionFromParcel(int tag, Parcel parcel) {
		if (tag == PersonaBoundRemoteViews.BindingAction.tag)
     ...
     */
    public static final Parcelable.Creator<PersonaBoundRemoteViews> CREATOR = new Parcelable.Creator<PersonaBoundRemoteViews>() {
        public PersonaBoundRemoteViews createFromParcel(Parcel parcel) {
            return new PersonaBoundRemoteViews(parcel);
        }

        public PersonaBoundRemoteViews[] newArray(int size) {
            return new PersonaBoundRemoteViews[size];
        }
    };
}
