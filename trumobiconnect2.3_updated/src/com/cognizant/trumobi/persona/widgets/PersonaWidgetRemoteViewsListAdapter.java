 ...
 *
 */
public class PersonaWidgetRemoteViewsListAdapter extends PersonaScrollableBaseAdapter {

    private PersonaBoundRemoteViews mRemoteViews = null;
     ...
     * @param listViewId
     */
    public PersonaWidgetRemoteViewsListAdapter(Context context, Intent intent, ComponentName provider,
        ...
        mRemoteViews = (PersonaBoundRemoteViews)intent.getParcelableExtra(PersonaLauncherIntent.Extra.Scroll.EXTRA_ITEM_LAYOUT_REMOTEVIEWS);
	...
	final Runnable mQueryDataRunnable = new Runnable() {
		public void run() {
	       PersonaLog.d("LAUNCHER","API v2 START QUERY");
    ...
    private class MyQueryHandler extends AsyncQueryHandler
    {
		...
		protected void onQueryComplete(int token, Object cookie,
            ...
            PersonaLog.d("LAUNCHER","API v2 QUERY COMPLETE");
