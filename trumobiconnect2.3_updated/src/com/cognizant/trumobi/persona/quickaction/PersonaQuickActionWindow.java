...
package com.cognizant.trumobi.persona.quickaction;
 ...
 *
 */
public class PersonaQuickActionWindow extends PopupWindow implements KeyEvent.Callback {
    ...
    /**
     * Creates a new Instance of the PersonaQuickActionWindow
     * 
     ...
     */
	public PersonaQuickActionWindow(Context context, View pView, Rect rect) {
		super(context);
		...
		contentView = mInflater.inflate(R.layout.pr_quickaction, null);
		...
		mTrackAnim = AnimationUtils.loadAnimation(mContext, R.anim.pr_quickaction);
	...
	/**
	 * Adds an item to the PersonaQuickActionWindow
	 * 
	...
	public void addItem(Drawable drawable, String text, OnClickListener l) {
		PersonaQuickActionItem view = (PersonaQuickActionItem) mInflater.inflate(R.layout.pr_quickaction_item, mTrack, false);
	...
	private void showArrow(int whichArrow, int requestedX) {
		...
		final int arrowWidth = mContext.getResources().getDrawable(R.drawable.pr_quickaction_arrow_up).getIntrinsicWidth();
