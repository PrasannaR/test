 ...
 *
 */
public class PersonaQuickActionItem extends LinearLayout implements Checkable {
    ...
    /**
     * Creates a new Instance of a PersonaQuickActionItem
     * 
     * @param context Context to use, usually your Appication or your Activity
     * @param attrs A collection of attributes, as found associated with a tag in an XML document
     */
    public PersonaQuickActionItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
