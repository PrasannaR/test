...
public class EmSSLSocketFactory implements LayeredSocketFactory {
     ...
     */
    private static final EmSSLSocketFactory DEFAULT_FACTORY = new EmSSLSocketFactory();
    
    /**
     * Gets an singleton instance of the SSLProtocolSocketFactory.
     * @return a SSLProtocolSocketFactory
     */
    public static EmSSLSocketFactory getSocketFactory() {
    ...
    public EmSSLSocketFactory(final KeyStore keystore, final String keystorePassword) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
        this(TLS, keystore, keystorePassword, null, null, null);
    }

    public EmSSLSocketFactory(final KeyStore truststore) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
     ...
     * SSLSocketFactory.
     */
    public EmSSLSocketFactory(javax.net.ssl.SSLSocketFactory socketfactory) {
        super();
