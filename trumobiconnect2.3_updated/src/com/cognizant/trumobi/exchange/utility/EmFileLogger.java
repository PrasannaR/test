...
public class EmFileLogger {
    private static EmFileLogger LOGGER = null;
    private static FileWriter sLogWriter = null;
    public static String LOG_FILE_NAME =
        Environment.getExternalStorageDirectory() + "/emaillog.txt";

    public synchronized static EmFileLogger getLogger (Context c) {
        LOGGER = new EmFileLogger();
        return LOGGER;
    }

    private EmFileLogger() {
        try {
