...
public class EmTags {
    ...
    public static final int SETTINGS_PRIMARY_SMTP_ADDRESS = SETTINGS_PAGE + 0x23;  //USER_SETTINGS_INFO_CHG
    public static final int SETTINGS_USER_ACCOUNTS = SETTINGS_PAGE + 0x24;    //USER_SETTINGS_INFO_CHG
    public static final int SETTINGS_USER_ACCOUNT = SETTINGS_PAGE + 0x25;	//USER_SETTINGS_INFO_CHG
    //USER_SETTINGS_INFO_CHG, <--
    ...
    static public String[][] pages = {
        ...
        },
        {
            ...
            , "PrimarySmtpAddress", "Accounts", "Account"	//USER_SETTINGS_INFO_CHG
        },
        {
