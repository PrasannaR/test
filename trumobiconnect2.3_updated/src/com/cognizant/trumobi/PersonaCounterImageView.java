...
public class PersonaCounterImageView extends ImageView {
    ...
    public PersonaCounterImageView(Context context) {
        super(context);
        init();
    }

    public PersonaCounterImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PersonaCounterImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }
    private void init(){
        final float scale =getResources().getDisplayMetrics().density;
        final int fontSize = (int)(PersonaAlmostNexusSettingsHelper.getNotifSize(getContext()) * scale + 0.5f);
