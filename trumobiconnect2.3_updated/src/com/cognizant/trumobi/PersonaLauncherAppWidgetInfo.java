 ...
 */
class PersonaLauncherAppWidgetInfo extends PersonaItemInfo {
     ...
     * until PersonaLauncher knows it's needed.
     */
    AppWidgetHostView hostView = null;

    PersonaLauncherAppWidgetInfo(int appWidgetId) {
        itemType = PersonaLauncherSettings.Favorites.ITEM_TYPE_APPWIDGET;
