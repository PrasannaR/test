...
public class PersonaPreviewsHolder extends ViewGroup {
	private int[][] distro={{1},{2},{1,2},{2,2},{2,1,2},{2,2,2},{2,3,2}};
	private int maxPreviewWidth;
	private int maxPreviewHeight;
	public PersonaPreviewsHolder(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public PersonaPreviewsHolder(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public PersonaPreviewsHolder(Context context, AttributeSet attrs, int defStyle) {
