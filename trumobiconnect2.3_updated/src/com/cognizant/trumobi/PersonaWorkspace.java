...
MultiTouchObjectCanvas<Object>, FlingListener {
	...
	//MediaPlayer _shootMP= MediaPlayer.create(getContext(), Uri.parse("android.resource://com.pkgname/" + R.raw.nokia));
	//AudioManager meng = (AudioManager) Context.getSystemService(Context.AUDIO_SERVICE);

	MediaPlayer _shootMP=new MediaPlayer();//= MediaPlayer.create(getContext(), Uri.parse("android.resource://com.pkgname/" + R.raw.six));
			...
			if(PersonaLauncher.wsettings==3)
			{
				if(mycurrentscreen==2)
				{
					...
					if (_shootMP != null)
						...
						/*	_shootMP.reset();
							_shootMP.setDataSource(getContext(), Uri.parse("android.resource://com.pkgname/" + R.raw.six));
							_shootMP.prepare();
							_shootMP.start();*/
