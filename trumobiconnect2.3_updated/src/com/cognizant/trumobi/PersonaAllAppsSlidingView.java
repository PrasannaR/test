...
import com.cognizant.trumobi.PersonaHolderLayout.OnFadingListener;
public class PersonaAllAppsSlidingView extends AdapterView<PersonaApplicationsAdapter> implements OnItemClickListener, OnItemLongClickListener, PersonaDragSource, PersonaDrawer{// implements PersonaDragScroller{
	...
	private PersonaApplicationsAdapter mAdapter;
    /**
     ...
     * Acts upon click
     */
    private PersonaAllAppsSlidingView.PerformClick mPerformClick;
    /**
    ...
    private PersonaPreviewPager mPager;
    ...
    private final int mScrollingSpeed=300; 
    //ADW: bounce scroll
    private final int mScrollingBounce=50;
    //ADW:Bg color
    private int mBgColor=0xFF000000;
    private int mStatus=PersonaHolderLayout.OnFadingListener.CLOSE;
	public PersonaAllAppsSlidingView(Context context) {
		super(context);
		initWorkspace();
	}
	public PersonaAllAppsSlidingView(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.absListViewStyle);
        initWorkspace();
	}
	public PersonaAllAppsSlidingView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initWorkspace() {
        ...
        mPager=new PersonaPreviewPager(getContext());
    ...
    public void setLauncher(PersonaLauncher personaLauncher) {
        ...
        setSelector(PersonaIconHighlights.getDrawable(mLauncher,PersonaIconHighlights.TYPE_DESKTOP));
    }
	@Override
    ...
    private void layoutChildren(){
        ...
        for (int i = 0; i < getChildCount(); i++) {
        	if(getChildAt(i) instanceof PersonaHolderLayout){
    ...
    public void makePage(int pageNum) {
        ...
        PersonaAllAppsSlidingView.LayoutParams p;
        p = new PersonaAllAppsSlidingView.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,
        		ViewGroup.LayoutParams.FILL_PARENT);
        int pos=startPos;
        int x=marginLeft;
        int y=marginTop;
        PersonaHolderLayout holder=new PersonaHolderLayout(getContext());
        ...
        PersonaAllAppsSlidingView.LayoutParams holderParams=new PersonaAllAppsSlidingView.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,ViewGroup.LayoutParams.FILL_PARENT);
        ...
        if(pageNum==mCurrentScreen && isAnimating){
            if(mStatus==PersonaHolderLayout.OnFadingListener.OPEN)
    ...
    private void addRemovePages(int current, int next){
    	...
    	if(removePage>=0 && removePage<mTotalScreens){
    		PersonaHolderLayout h=null;
    		for(int i=1;i<getChildCount();i++){
    			if(getChildAt(i).getTag().equals(removePage)){
    				h=(PersonaHolderLayout) getChildAt(i);
    				break;
    			}
    		}
    		if(h!=null){
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            if (child!=null) {
	            ...
	            postDelayed(mPendingCheckForTap, 400); 
        ...
        case MotionEvent.ACTION_UP:
            if (mTouchState == TOUCH_STATE_SCROLLING) {
            	...
            	if(child!=null && child.equals(pointToView((int)x, (int)y))){
	                ...
	                final PersonaAllAppsSlidingView.PerformClick performClick = mPerformClick;
        ...
        boolean handled=commonKey(keyCode, 1, event);
            ...
            case KeyEvent.KEYCODE_ENTER:
		        if (isPressed() && mSelectedPosition >= 0 && mAdapter != null &&
		            ...
		            final PersonaHolderLayout h=(PersonaHolderLayout)getChildAt(mCurrentHolder);
    ...
    boolean resurrectSelection() {
    	...
    	final PersonaHolderLayout h=(PersonaHolderLayout) getChildAt(mCurrentHolder);
    	if(h!=null && h instanceof PersonaHolderLayout){
    ...
    public View getViewAtPosition(int pos){
    	...
    	if(h!=null){
    		if(h instanceof PersonaHolderLayout)v=h.getChildAt(position);
    	}
    	return v;
    }
    @Override
	...
	@Override
	public PersonaApplicationsAdapter getAdapter() {
		// TODO Auto-generated method stub
		return mAdapter;
	}
	@Override
    ...
    class RecycleBin {
        ...
        void fillActiveViews(int childCount, int firstActivePosition) {
            ...
            for (int i = 0; i < childCount; i++) {
            	View child = getChildAt(i);
                PersonaAllAppsSlidingView.LayoutParams lp = (PersonaAllAppsSlidingView.LayoutParams)child.getLayoutParams();
            ...
            for(int i=0;i<activeViews.length;i++){
            	//PersonaLog.d("MyRecycler","We have recycled activeview "+i);
            	//PersonaLog.d("MyRecycler","So whe we call it will be "+(i-mFirstActivePosition));
            }
        }
        ...
        View getActiveView(int position) {
            ...
            final View[] activeViews = mActiveViews;
            //PersonaLog.d("MyRecycler","We're recovering view "+index+" of a list of "+activeViews.length);
        ...
        void addScrapView(View scrap) {
            PersonaAllAppsSlidingView.LayoutParams lp = (PersonaAllAppsSlidingView.LayoutParams) scrap.getLayoutParams();
            if (lp == null) {
                return;
            }
        ...
        void scrapActiveViews() {
            ...
            for (int i = 0; i < count; ++i) {
                ...
                if (victim != null) {
                    int whichScrap = ((PersonaAllAppsSlidingView.LayoutParams)
    ...
    private boolean performLongPress(final View child,
        ...
        if (getOnItemLongClickListener() != null) {
            handled = getOnItemLongClickListener().onItemLongClick(PersonaAllAppsSlidingView.this, child,
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new PersonaAllAppsSlidingView.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof PersonaAllAppsSlidingView.LayoutParams;
    }
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (PersonaAllAppsSlidingView.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
            	PersonaAllAppsSlidingView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            }
            mBlockLayouts=false;
            requestLayout();
        ...
        public void onInvalidated() {
            ...
            if (PersonaAllAppsSlidingView.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = PersonaAllAppsSlidingView.this.onSaveInstanceState();
            }
	...
	public void onItemClick(AdapterView<?> adapter, View v, int position, long id) {
		// TODO Auto-generated method stub
        PersonaApplicationInfo app = (PersonaApplicationInfo) getItemAtPosition(position);
	...
	public boolean onItemLongClick(AdapterView<?> parent, View v,
        ...
        app = new PersonaApplicationInfo(app);

        mDragger.startDrag(v, this, app, PersonaDragController.DRAG_ACTION_COPY);
        if(!mLauncher.isDockBarOpen() || PersonaAlmostNexusSettingsHelper.getUICloseAppsDockbar(mLauncher)){
	...
	public void open(boolean animate) {
	    mStatus=PersonaHolderLayout.OnFadingListener.OPEN;
		mBgColor=PersonaAlmostNexusSettingsHelper.getDrawerColor(mLauncher);
		mTargetAlpha=Color.alpha(mBgColor);
		for(int i=0;i<getChildCount();i++){
			if(getChildAt(i) instanceof PersonaHolderLayout){
				((PersonaHolderLayout)getChildAt(i)).updateLabelVars(mLauncher);
			}
		}
		mScroller.forceFinished(true);
		setVisibility(View.VISIBLE);
		findCurrentHolder();
        final PersonaHolderLayout holder=(PersonaHolderLayout) getChildAt(mCurrentHolder);
        if(getAdapter()==null)
        	animate=false;
        ...
        if(animate){
            ...
            if (adapter instanceof PersonaApplicationsAdapter)
                ((PersonaApplicationsAdapter)adapter).setChildDrawingCacheEnabled(true);
	...
	public void close(boolean animate){
	    mStatus=PersonaHolderLayout.OnFadingListener.CLOSE;
		setPressed(false);
		mPager.setVisibility(INVISIBLE);
        if(getAdapter()==null)
        	animate=false;
    	...
    	if(animate){
    		findCurrentHolder();
    		PersonaHolderLayout holder=(PersonaHolderLayout) getChildAt(mCurrentHolder);
    		if(holder!=null){
    		    isAnimating=true;
