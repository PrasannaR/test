...
public class TruMobiBaseSherlockFragmentBaseActivity extends SherlockFragmentActivity{

	public LocalBroadcastManager mLocalBcMgr;
	public static boolean bkillActivity = false;
    public static Context context;
    
    private static String TAG = TruMobiBaseSherlockFragmentBaseActivity.class.getName();
	@Override
...
//		}
	...
	private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {	
			bkillActivity = true;
			TruMobiBaseActivity.bkillActivity = true;
			finish();
		}
	};
