...
public class TruMobiBaseSherlockPreferenceActivity extends SherlockPreferenceActivity{
	
	public LocalBroadcastManager mLocalBcMgr;
	public static boolean bkillActivity = false;
    public static Context context;
    
    private static String TAG = TruMobiBaseSherlockPreferenceActivity.class.getName();
	@Override
