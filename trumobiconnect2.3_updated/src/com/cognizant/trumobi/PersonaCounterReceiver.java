 ...
 *
 */
public class PersonaCounterReceiver extends BroadcastReceiver {
    private HashMap<String, FilterData> mReceiverFilter;
    private OnCounterChangedListener mListener;
    public PersonaCounterReceiver(Context context) {
    ...
    private void parseFilters(Context context) {
        XmlPullParser parser = context.getResources().getXml(R.xml.pr_counter_filter);
        try {
