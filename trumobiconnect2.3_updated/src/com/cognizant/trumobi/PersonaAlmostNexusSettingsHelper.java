...
public final class PersonaAlmostNexusSettingsHelper {
	...
	public static void setSwipeDownAppToLaunch(Context context, PersonaApplicationInfo info)
	{
	...
	public static void setSwipeUpAppToLaunch(Context context, PersonaApplicationInfo info)
	{
		SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sp.edit();
	...
	public static void setHomeBindingAppToLaunch(Context context, PersonaApplicationInfo info)
	{
		SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sp.edit();
	...
	public static int getDesktopScreens(Context context) {
		...
		try
		{
			...
			{
				screens = sp.getInt("desktopScreens", context.getResources().getInteger(R.integer.config_desktopScreens))+1;
				return screens;
			}
	...
	public static int audio_setting(Context context) {
		SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
		//int audio1 = sp.getInt("audio_setting", context.getResources().getInteger(R.integer.config_Audio));
		int audio1 = Integer.valueOf(sp.getString("audio_setting", context.getResources().getString(R.string.config_Audio)));
		return audio1;

	}

	public static int workspace_settings(Context context) {
		SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
		int wspace = Integer.valueOf(sp.getString("workspacescreen", context.getResources().getString(R.string.config_workspace)));
		return wspace;
...
/*	public static boolean getWallpaperScrolling(Context context) {
	...
	/*public static class ChangelogDialogBuilder {
		public static AlertDialog create( Context context ) throws NameNotFoundException {
			...
			String aboutTitle = String.format("%s ", context.getString(R.string.adw_version));
			//String aboutTitle = "Disclaimer";
...
*/
	public static boolean getDebugShowMemUsage(Context context) {
		if(PersonaMyLauncherSettings.IsDebugVersion){
			SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
