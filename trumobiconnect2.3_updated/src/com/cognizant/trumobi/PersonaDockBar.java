...
public class PersonaDockBar extends LinearLayout implements OnClickListener {
	...
	public PersonaDockBar(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	@SuppressWarnings("unused")
	public PersonaDockBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
        ...
        mPosition = a.getInt(
                R.styleable.DockBar_position_mod, mPosition);
        a.recycle();
    ...
    protected void onFinishInflate() {
    	...
    	if(mHandleId!=0){
	    	...
	    	/*if (mHandle == null) {
	    		...
	    		throw new RuntimeException("Your PersonaDockBar must have a child View whose id attribute is 'R.id." + name + "'");
	    	}*/
    		if(mHandle!=null)
