...
public class PersonaActivityPickerActivity extends ExpandableListActivity {
    ...
    protected void onCreate(Bundle savedState) {
        ...
        setContentView(R.layout.pr_activity_list);
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public TextView getGenericView() {
            TextView textView = new TextView(PersonaActivityPickerActivity.this);
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ...
            textView.setCompoundDrawablesWithIntrinsicBounds(PersonaUtilities.createIconThumbnail(info.applicationInfo.loadIcon(mPackageManager),PersonaActivityPickerActivity.this), null, null, null);
            return textView;
        }
