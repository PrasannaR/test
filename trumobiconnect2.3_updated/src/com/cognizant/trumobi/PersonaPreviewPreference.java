...
public class PersonaPreviewPreference extends Preference {
	...
	public PersonaPreviewPreference(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public PersonaPreviewPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public PersonaPreviewPreference(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onBindView(View view) {
		...
		if(themePackageName!=null && themePackageName.toString().length()>0){
			...
			if(themePreview!=null)
				...
				vThemePreview.setImageResource(R.drawable.pr_ic_launcher_wallpaper);
			vThemeTitle.setText(themeName);
