...
public class PersonaEmail_Content_Provider extends ContentProvider {
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		case CORPORATE_EMAIL:
			...
			id = mPersonaEncryptDb.insert(PersonaPimSettingsDbHelper.TABLE_EMAIL, null, values);
			break;
		default:
			throw new IllegalArgumentException("Unknown URI: " + uri);
		}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		mPersonaEncryptDb = getEncryptedDatabaseInstance();
		Cursor cursor = mPersonaEncryptDb.query(PersonaPimSettingsDbHelper.TABLE_EMAIL, projection, selection,
				selectionArgs, null, null, sortOrder);
		cursor.setNotificationUri(getContext().getContentResolver(), uri);
	...
	public int update(Uri uri, ContentValues values, String selections,
		...
		rowsUpdated = mPersonaEncryptDb.update(PersonaPimSettingsDbHelper.TABLE_EMAIL, values, selections,
				selectionArgs);
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		int deleteCount = mPersonaEncryptDb.delete(PersonaPimSettingsDbHelper.TABLE_EMAIL, selection,
				selectionArgs);
	...
	//BYOD_DB_NOTCLOSED_FIX 19Dec2013 
	PersonaPimSettingsDbHelper personDbHelper;

	TruBoxDatabase localTruBoxdb = null;
	private TruBoxDatabase getEncryptedDatabaseInstance(){
		
		// Added new Encryption for Persona db
		if(localTruBoxdb == null)
		{
				personDbHelper = new PersonaPimSettingsDbHelper(getContext());
				localTruBoxdb = personDbHelper.getTruboxDynamicWritableDatabase(getContext());
		}
