...
public class PersonaUninstallShortcutReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent data) {
        ...
        if (intent != null && name != null) {
            ...
            Cursor c = cr.query(PersonaLauncherSettings.Favorites.CONTENT_URI,
                new String[] { PersonaLauncherSettings.Favorites._ID, PersonaLauncherSettings.Favorites.INTENT },
                PersonaLauncherSettings.Favorites.TITLE + "=?", new String[] { name }, null);
                ...
                while (c.moveToNext()) {
                    try {
                        if (intent.filterEquals(Intent.parseUri(c.getString(intentIndex), 0))) {
                            ...
                            final Uri uri = PersonaLauncherSettings.Favorites.getContentUri(id, false);
            ...
            if (changed) {
                cr.notifyChange(PersonaLauncherSettings.Favorites.CONTENT_URI, null);
