 ...
 */
public class PersonaCustomScroller  {
    private int mMode;
    ...
    /**
     * Create a PersonaCustomScroller with the default duration and interpolator.
     */
    public PersonaCustomScroller(Context context) {
        this(context, null);
    }

    /**
     * Create a PersonaCustomScroller with the specified interpolator. If the interpolator is
     * null, the default (viscous) interpolator will be used.
     */
    public PersonaCustomScroller(Context context, Interpolator interpolator) {
        mFinished = true;
