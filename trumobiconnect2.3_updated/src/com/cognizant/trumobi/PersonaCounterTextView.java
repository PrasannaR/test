...
public class PersonaCounterTextView extends TextView {
    ...
    public PersonaCounterTextView(Context context) {
        super(context);
        init();
    }

    public PersonaCounterTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PersonaCounterTextView(Context context, AttributeSet attrs, int defStyle) {
