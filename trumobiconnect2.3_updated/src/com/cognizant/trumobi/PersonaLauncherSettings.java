...
class PersonaLauncherSettings {
    ...
    static final class Favorites implements BaseLauncherColumns {
       ...
       /* static final Uri CONTENT_URI = Uri.parse("content://" +
                PersonaLauncherProvider.AUTHORITY + "/" + PersonaLauncherProvider.TABLE_FAVORITES +
                "?" + PersonaLauncherProvider.PARAMETER_NOTIFY + "=true");*/
        
        static final Uri CONTENT_URI = Uri.parse("content://" +
                PersonaLauncherDbEncryptHelper.AUTHORITY + "/" + PersonaLauncherDbEncryptHelper.TABLE_FAVORITES +
                "?" + PersonaLauncherProvider.PARAMETER_NOTIFY + "=true");
        ...
        /*static final Uri CONTENT_URI_NO_NOTIFICATION = Uri.parse("content://" +
                PersonaLauncherProvider.AUTHORITY + "/" + PersonaLauncherProvider.TABLE_FAVORITES +
                "?" + PersonaLauncherProvider.PARAMETER_NOTIFY + "=false");*/
       ...
       /* static Uri getContentUri(long id, boolean notify) {
            return Uri.parse("content://" + PersonaLauncherProvider.AUTHORITY +
                    "/" + PersonaLauncherProvider.TABLE_FAVORITES + "/" + id + "?" +
                    PersonaLauncherProvider.PARAMETER_NOTIFY + "=" + notify);*/
            
        static Uri getContentUri(long id, boolean notify) {
                return Uri.parse("content://" + PersonaLauncherDbEncryptHelper.AUTHORITY +
                        "/" + PersonaLauncherDbEncryptHelper.TABLE_FAVORITES + "/" + id + "?" +
                        PersonaLauncherProvider.PARAMETER_NOTIFY + "=" + notify);    
        }
