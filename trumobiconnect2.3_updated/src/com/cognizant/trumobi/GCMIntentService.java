...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    public GCMIntentService() {
        ...
        PersonaLog.e(LOG_TAG, "******** GCMIntent cns ");
    ...
    protected void onRegistered(Context context, String registrationId) {
        PersonaLog.i(TAG, "Device registered: regId = " + registrationId);
    ...
    protected void onMessage(Context context, Intent intent) {
      ...
      //  String message = getString(R.string.gcm_message);
       // PersonaCommonfunctions.displayMessage(context, message);
		...
		mGCMcontext = context;
		try {
			// System.out.println("*********** 4-3- "+String.valueOf(mdmCommandProcessingThread.getState()).equals("NEW"));
		...
		synchronized (mdmCommandProcessingThread) {
			...
			boolean isBlockAppRequired;
			String uid;
			if (text != null) {
				PersonaLog.e(LOG_TAG, "" + text);
				String test = (text.replace("||", ","));
				String[] temp = test.split(",");

				if (temp[0] != null) {
					PersonaLog.e(LOG_TAG, "" + temp[0]);
					message = temp[0];
				...
				{
					// PersonaLog.i(TAG, "has 3 segments...");
			...
			/*		if (temp[2] != null
						...
						PersonaLog.e("profileName: ", temp[2]);

						if (temp[3] != null) {

							PersonaLog.e("profileName:uid ", temp[3]);
							uid = temp[3];
   ...
   /* @Override
    protected void onDeletedMessages(Context context, int total) {
        PersonaLog.i(TAG, "Received deleted messages notification");
