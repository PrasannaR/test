...
public class PersonaHolderLayout extends ViewGroup {
    //ADW: Animation vars
    ...
    private int xx;
	public PersonaHolderLayout(Context context) {
		super(context);
	...
	public PersonaHolderLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		mPaint=new Paint();
		mPaint.setDither(false);
	...
	public PersonaHolderLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
    	//PersonaLog.d("PersonaHolderLayout","INTERCEPT");
		return true;
    }
    @Override
    public boolean onTouchEvent(MotionEvent ev) {
    	//PersonaLog.d("PersonaHolderLayout","TOUCH");
		return true;
    }
    /**
    ...
    public void updateLabelVars(Context context){
    	mDrawLabels=PersonaAlmostNexusSettingsHelper.getDrawerLabels(context);
    	mFadeDrawLabels=PersonaAlmostNexusSettingsHelper.getFadeDrawerLabels(context);
    }
}
