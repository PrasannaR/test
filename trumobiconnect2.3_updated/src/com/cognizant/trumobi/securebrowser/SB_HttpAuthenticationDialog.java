 ...
 */
public class SB_HttpAuthenticationDialog {
     ...
     */
    public SB_HttpAuthenticationDialog(Context context, String host, String realm) {
        mContext = context;
        mHost = host;
        mRealm = realm;
        SB_Log.sbI("HOST", "ON RECEIVED HTTP AUTH HOST3: " + host);	
        createDialog();
    }
    ...
    private void createDialog() {
        ...
        View v = factory.inflate(R.layout.sb_http_authentication, null);
        ...
        String title = mContext.getText(R.string.sign_in_to).toString() + " " + mHost ;
        SB_Log.sbI("HOST", "ON RECEIVED HTTP AUTH HOST4: " + title);	
