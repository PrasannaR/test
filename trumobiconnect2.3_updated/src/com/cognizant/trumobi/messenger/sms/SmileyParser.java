...
public class SmileyParser {
    ...
    static class Smileys {
        private static final int[] sIconIds = {
            R.drawable.sms_emo_im_happy,
            R.drawable.sms_emo_im_sad,
            R.drawable.sms_emo_im_winking,
            R.drawable.sms_emo_im_tongue_sticking_out,
            R.drawable.sms_emo_im_surprised,
            R.drawable.sms_emo_im_kissing,
            R.drawable.sms_emo_im_yelling,
            R.drawable.sms_emo_im_cool,
            R.drawable.sms_emo_im_money_mouth,
            R.drawable.sms_emo_im_foot_in_mouth,
            R.drawable.sms_emo_im_embarrassed,
            R.drawable.sms_emo_im_angel,
            R.drawable.sms_emo_im_undecided,
            R.drawable.sms_emo_im_crying,
            R.drawable.sms_emo_im_lips_are_sealed,
            R.drawable.sms_emo_im_laughing,
            R.drawable.sms_emo_im_wtf,
            R.drawable.sms_emo_im_heart,
            R.drawable.sms_emo_im_mad,
            R.drawable.sms_emo_im_smirk,
            R.drawable.sms_emo_im_pokerface
        };
