 ...
 *
 */
public abstract class EmEmailContent {
    public static final String AUTHORITY = EmEmailProvider.EMAIL_AUTHORITY;
	...
	private static final String LOG_TAG = EmEmailContent.class.getName();
    ...
    public abstract <T extends EmEmailContent> T restore (Cursor cursor);
    ...
    static public <T extends EmEmailContent> T getContent(Cursor cursor, Class<T> klass) {
        try {
    ...
    public static final class Body extends EmEmailContent implements BodyColumns {
        public static final String TABLE_NAME = "Body";
        public static final Uri CONTENT_URI = Uri.parse(EmEmailContent.CONTENT_URI + "/body");
        ...
        @Override
        @SuppressWarnings("unchecked")
        public EmEmailContent.Body restore(Cursor c) {
            mBaseUri = EmEmailContent.Body.CONTENT_URI;
    ...
    public static final class Message extends EmEmailContent implements SyncColumns, MessageColumns {
        ...
        public static final Uri CONTENT_URI = Uri.parse(EmEmailContent.CONTENT_URI + "/message");
        public static final Uri SYNCED_CONTENT_URI =
            Uri.parse(EmEmailContent.CONTENT_URI + "/syncedMessage");
        public static final Uri DELETED_CONTENT_URI =
            Uri.parse(EmEmailContent.CONTENT_URI + "/deletedMessage");
        public static final Uri UPDATED_CONTENT_URI =
            Uri.parse(EmEmailContent.CONTENT_URI + "/updatedMessage");
        
        public static final String MESSAGES_FOR_ACCOUNT_SELECTION = MessageColumns.ACCOUNT_KEY + "=?";
        ...
        public Message() {
		 ...
		 // CONTAINER CHANGES 
     		public static final String[] CONTAINER_CONTENT_PROJECTION = new String[] {
     				TABLE_NAME + "." + RECORD_ID,
     				TABLE_NAME + "." + MessageColumns.DISPLAY_NAME,
     				TABLE_NAME + "." + MessageColumns.SUBJECT,
     				TABLE_NAME + "." + MessageColumns.FLAG_READ,
     				TABLE_NAME + "." + SyncColumns.SERVER_ID,
     				TABLE_NAME + "." + MessageColumns.CLIENT_ID,
     				TABLE_NAME + "." + MessageColumns.MESSAGE_ID,
     				TABLE_NAME + "." + MessageColumns.MAILBOX_KEY,
     				TABLE_NAME + "." + MessageColumns.FROM_LIST,
     				TABLE_NAME + "." + MessageColumns.TIMESTAMP,
     				Attachment.TABLE_NAME + "." + AttachmentColumns.FILENAME,
     				Attachment.TABLE_NAME + "." + AttachmentColumns.LOCATION,
     				Attachment.TABLE_NAME + "." + AttachmentColumns.SIZE,
     				Attachment.TABLE_NAME + "." + AttachmentColumns.CONTENT_URI,
     				Attachment.TABLE_NAME + "."	+ AttachmentColumns.CONTAINER_BOOKMARK,
     				Attachment.TABLE_NAME + "." + AttachmentColumns.ID,
     				TABLE_NAME + "." + MessageColumns.ACCOUNT_KEY
     				};

     		public static final int CONTAINER_LIST_ID_COLUMN = 0;
     		public static final int CONTAINER_LIST_DISPLAY_NAME_COLUMN = 1;
     		public static final int CONTAINER_LIST_SUBJECT_COLUMN = 2;
     		public static final int CONTAINER_LIST_READ_COLUMN = 3;
     		public static final int CONTAINER_LIST_SERVER_ID_COLUMN = 4;
     		public static final int CONTAINER_LIST_CLIENT_ID_COLUMN = 5;
     		public static final int CONTAINER_LIST_MESSAGE_ID_COLUMN = 6;
     		public static final int CONTAINER_LIST_MAILBOX_KEY_COLUMN = 7;
     		public static final int CONTAINER_LIST_FROM_LIST_COLUMN = 8;
     		public static final int CONTAINER_LIST_SERVER_TIMESTAMP_COLUMN = 9;
     		
     		public static final int CONTAINER_LIST_ATTACHMENT_FILENAME_COLUMN = 10;
     		public static final int CONTAINER_LIST_ATTACHMENT_LOCATION_COLUMN = 11;//Attachment ID
     		public static final int CONTAINER_LIST_ATTACHMENT_SIZE_COLUMN = 12;
     		public static final int CONTAINER_LIST_ATTACHMENT_CONTENT_URI_COLUMN = 13;//Attachment URI
     		public static final int CONTAINER_LIST_ATTACHMENT_CONTAINER_BOOKMARK_COLUMN = 14;
     		public static final int CONTAINER_LIST_ATTACHMENT_TABLE_ID_COLUMN = 15;
     		public static final int CONTAINER_LIST_ACCOUNT_KEY_COLUMN = 16;
        ...
        @Override
        @SuppressWarnings("unchecked")
        public EmEmailContent.Message restore(Cursor c) {
            mBaseUri = CONTENT_URI;
         ...
         * (non-Javadoc)
         * @see com.cognizant.trumobi.em.provider.EmailContent#save(android.content.Context)
         */
        @Override
        public Uri save(Context context) {
            ...
            try {
                ContentProviderResult[] results =
                    context.getContentResolver().applyBatch(EmEmailProvider.EMAIL_AUTHORITY, ops);
    ...
    public static final class Account extends EmEmailContent implements AccountColumns, Parcelable {
        public static final String TABLE_NAME = "Account";
        public static final Uri CONTENT_URI = Uri.parse(EmEmailContent.CONTENT_URI + "/account");
        public static final Uri ADD_TO_FIELD_URI =
            Uri.parse(EmEmailContent.CONTENT_URI + "/accountIdAddToField");
        ...
        @Override
        @SuppressWarnings("unchecked")
        public EmEmailContent.Account restore(Cursor cursor) {
        ...
        public void setStoreUri(Context context, String storeUri) {
            ...
            if (mHostAuthRecv == null) {
                if (mHostAuthKeyRecv != 0) {
                    ...
                    mHostAuthRecv = new EmEmailContent.HostAuth();
                }
            }
        ...
        public void setSenderUri(Context context, String senderUri) {
            ...
            if (mHostAuthSend == null) {
                if (mHostAuthKeySend != 0) {
                    ...
                    mHostAuthSend = new EmEmailContent.HostAuth();
                }
            }
         ...
         * {@code content://com.cognizant.trumobi.em.provider/account/UUID} format, which is safe to use
         * for desktop shortcuts.
         *
         * <p>We don't want to store _id in shortcuts, because
         * {@link com.cognizant.trumobi.em.EmAccountBackupRestore} won't preserve it.
         */
        ...
        /**
         * Parse {@link Uri} in the {@code content://com.cognizant.trumobi.em.provider/account/ID} format
        ...
        public static long getAccountIdFromShortcutSafeUri(Context context, Uri uri) {
            ...
            if (!"content".equals(uri.getScheme())
                    || !EmEmailContent.AUTHORITY.equals(uri.getAuthority())) {
                return -1;
            }
        ...
        static public long getDefaultAccountId(Context context) {
            ...
            if (id == -1) {
                //id = getDefaultAccountWhere(context, null);	//NaGa, for deselect default account, for first account
            	return -1;
            }
            return id;
        }
         ...
         * Supports Parcelable
         */
        public static final Parcelable.Creator<EmEmailContent.Account> CREATOR
                = new Parcelable.Creator<EmEmailContent.Account>() {
            public EmEmailContent.Account createFromParcel(Parcel in) {
                return new EmEmailContent.Account(in);
            }

            public EmEmailContent.Account[] newArray(int size) {
                return new EmEmailContent.Account[size];
            }
        };
        ...
        public Account(Parcel in) {
            mBaseUri = EmEmailContent.Account.CONTENT_URI;
            mId = in.readLong();
            ...
            mHostAuthRecv = null;
            if (in.readByte() == 1) {
                mHostAuthRecv = new EmEmailContent.HostAuth(in);
            }

            mHostAuthSend = null;
            if (in.readByte() == 1) {
                mHostAuthSend = new EmEmailContent.HostAuth(in);
            }
        }
  ...
  //Securebrowser 3-9-2013
	public interface SecureBrowserColumns {
		...
		// CONTAINER CHANGES Bookmark for Container
		public static final String CONTAINER_BOOKMARK = "containerBookmark";
		// CONTAINER CHANGES Bookmark for Container Attachment Delete
		public static final String CONTAINER_DELETE = "containerAttachmentDelete";
		
		
		
	}

	public static final class SecureBrowser extends EmEmailContent implements
	SecureBrowserColumns{

		public static final String TABLE_NAME = "securebrowser";
		@SuppressWarnings("hiding")
		public static final Uri CONTENT_URI = Uri
				.parse(EmEmailContent.CONTENT_URI + "/securebrowser");
		
		
		public static String[] CONTENT_PROJECTION_LIST_DETAILS = { 
			
			SecureBrowserColumns.ID,
			SecureBrowserColumns.FILENAME,
			SecureBrowserColumns.MIME_TYPE,
			SecureBrowserColumns.SIZE,
			SecureBrowserColumns.CONTENT_URI,
			SecureBrowserColumns.DATE_TIME,
			SecureBrowserColumns.URL,
			SecureBrowserColumns.CONTAINER_BOOKMARK
			
		};
		
		public static int LIST_SB_ID = 0;
		public static int LIST_SB_FILENAME = 1;
		public static int LIST_SB_MIME_TYPE = 2;
		public static int LIST_SB_SIZE = 3;
		public static int LIST_SB_CONTENT_URI = 4;
		public static int LIST_SB_DATE_TIME = 5;
		public static int LIST_SB_URL = 6;
		public static int LIST_SB_CONTAINER_BOOKMARK = 7;
		
		public static String[] CONTENT_PROJECTION_DELETE_DETAILS = {
			SecureBrowserColumns.ID, 
			SecureBrowserColumns.CONTENT_URI 
			
		};
		
		public static int LIST_SB_DELETE_ID = 0;
		public static int LIST_SB_DELETE_FILENAME = 1;
		...
		@Override
		public <T extends EmEmailContent> T restore(Cursor cursor) {
			// TODO Auto-generated method stub
			return null;
		}
    ...
    public static final class Attachment extends EmEmailContent implements AttachmentColumns {
        public static final String TABLE_NAME = "Attachment";
        public static final Uri CONTENT_URI = Uri.parse(EmEmailContent.CONTENT_URI + "/attachment");
        ...
        public static final Uri MESSAGE_ID_URI = Uri.parse(
                EmEmailContent.CONTENT_URI + "/attachment/message");
        ...
        @Override
        @SuppressWarnings("unchecked")
        public EmEmailContent.Attachment restore(Cursor cursor) {
            mBaseUri = CONTENT_URI;
            mId = cursor.getLong(CONTENT_ID_COLUMN);
        ...
        public Attachment(Parcel in) {
            mBaseUri = EmEmailContent.Attachment.CONTENT_URI;
            mId = in.readLong();
        ...
        public static final Parcelable.Creator<EmEmailContent.Attachment> CREATOR
        = new Parcelable.Creator<EmEmailContent.Attachment>() {
            public EmEmailContent.Attachment createFromParcel(Parcel in) {
                return new EmEmailContent.Attachment(in);
            }

            public EmEmailContent.Attachment[] newArray(int size) {
                return new EmEmailContent.Attachment[size];
            }
        };
    ...
    public static final class Mailbox extends EmEmailContent implements SyncColumns, MailboxColumns {
        public static final String TABLE_NAME = "Mailbox";
        public static final Uri CONTENT_URI = Uri.parse(EmEmailContent.CONTENT_URI + "/mailbox");
        public static final Uri ADD_TO_FIELD_URI =
            Uri.parse(EmEmailContent.CONTENT_URI + "/mailboxIdAddToField");
        
        public static final String MAILBOXES_FOR_ACCOUNT_SELECTION = MailboxColumns.ACCOUNT_KEY + "=?";
        public static final String MAILBOXES_FOR_ACCOUNT_EXCEPT_ACCOUNT_MAILBOX_SELECTION =
        ...
        public static final int CONTAINER_MAILBOX_COLUMN_ID = 0;


        /** Small projection for just the columns required for a sync. */
        public static final String[] CONTAINER_MAILBOX_PROJECTION = new String[] {
            MailboxColumns.ID,
        };
        
        
        //12-8-2013 CONTAINER CHANGES ENDS
        
     //13-8-2013 CONTAINER CHANGES
        
        public static final int CONTAINER_MAILACC_COLUMN_ID = 0;
        public static final int CONTAINER_MAILACC_COLUMN_ACC_ID = 1;


        /** Small projection for just the columns required for a sync. */
        public static final String[] CONTAINER_MAILACC_PROJECTION = new String[] {
            MailboxColumns.ID,
            MailboxColumns.ACCOUNT_KEY
        };
        
        
        //13-8-2013 CONTAINER CHANGES ENDS
        ...
        public static Mailbox restoreMailboxWithId(Context context, long id) {
            ...
            try {
                if (c.moveToFirst()) {
                    return EmEmailContent.getContent(c, Mailbox.class);
                } else {
                    return null;
                }
            } finally {
        ...
        @Override
        @SuppressWarnings("unchecked")
        public EmEmailContent.Mailbox restore(Cursor cursor) {
            mBaseUri = CONTENT_URI;
            mId = cursor.getLong(CONTENT_ID_COLUMN);
            mDisplayName = cursor.getString(CONTENT_DISPLAY_NAME_COLUMN);
    ...
    public static final class HostAuth extends EmEmailContent implements HostAuthColumns, Parcelable {
        public static final String TABLE_NAME = "HostAuth";
        public static final Uri CONTENT_URI = Uri.parse(EmEmailContent.CONTENT_URI + "/hostauth");
        ...
        public static HostAuth restoreHostAuthWithId(Context context, long id) {
            Uri u = ContentUris.withAppendedId(EmEmailContent.HostAuth.CONTENT_URI, id);
        ...
        @Override
        @SuppressWarnings("unchecked")
        public EmEmailContent.HostAuth restore(Cursor cursor) {
            mBaseUri = CONTENT_URI;
            mId = cursor.getLong(CONTENT_ID_COLUMN);
         ...
         * Supports Parcelable
         */
        public static final Parcelable.Creator<EmEmailContent.HostAuth> CREATOR
                = new Parcelable.Creator<EmEmailContent.HostAuth>() {
            public EmEmailContent.HostAuth createFromParcel(Parcel in) {
                return new EmEmailContent.HostAuth(in);
            }

            public EmEmailContent.HostAuth[] newArray(int size) {
                return new EmEmailContent.HostAuth[size];
            }
        };
     ...
     */
    public static void deleteSyncedDataSync(Context context, long accountId ) {
        try {
        	
            // Delete synced attachments
            EmAttachmentProvider.deleteAllAccountAttachmentFiles(context,
                    accountId);
            ...
            resolver.delete(Mailbox.CONTENT_URI,
                    Mailbox.MAILBOXES_FOR_ACCOUNT_EXCEPT_ACCOUNT_MAILBOX_SELECTION,
                    accountIdArgs);
            resolver.delete(Message.CONTENT_URI, Message.MESSAGES_FOR_ACCOUNT_SELECTION, accountIdArgs);
            ...
            resolver.update(Mailbox.CONTENT_URI, cv,
                    Mailbox.MAILBOXES_FOR_ACCOUNT_SELECTION, accountIdArgs);
           
        } catch (Exception e) {
            EmailLog.w(LOG_TAG, "Exception while deleting account synced data", e);
        }
    }
}
