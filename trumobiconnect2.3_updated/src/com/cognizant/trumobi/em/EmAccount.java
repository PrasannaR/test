...
public class EmAccount {
    ...
    private transient EmPreferences mPreferences;
    ...
    public EmAccount(Context context) {
    ...
    EmAccount(EmPreferences preferences, String uuid) {
        this.mUuid = uuid;
        refresh(preferences);
    }
     ...
     */
    public void refresh(EmPreferences preferences) {
        mPreferences = preferences;

        mStoreUri = EmUtility.base64Decode(preferences.mSharedPreferences.getString(mUuid
                + ".storeUri", null));
        ...
        mSenderUri = EmUtility.base64Decode(senderText);
        ...
        if (mDeletePolicy == DELETE_POLICY_NEVER && 
                mStoreUri != null && mStoreUri.toString().startsWith(EmStore.STORE_SCHEME_IMAP)) {
    ...
    public void delete(EmPreferences preferences) {
    ...
    public void save(EmPreferences preferences) {
        mPreferences = preferences;
        ...
        if (!preferences.mSharedPreferences.getString("accountUuids", "").contains(mUuid)) {
             ...
             */
            EmAccount[] accounts = preferences.getAccounts();
        ...
        editor.putString(mUuid + ".storeUri", EmUtility.base64Encode(mStoreUri));
        editor.putString(mUuid + ".localStoreUri", mLocalStoreUri);
        editor.putString(mUuid + ".senderUri", EmUtility.base64Encode(mSenderUri));
    ...
    public boolean equals(Object o) {
        if (o instanceof EmAccount) {
            return ((EmAccount)o).mUuid.equals(mUuid);
        }
