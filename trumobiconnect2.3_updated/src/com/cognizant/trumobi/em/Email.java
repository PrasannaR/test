...
public class Email extends TFApplication {
	...
	private void checkBugSenseEnableStatus() {
		boolean isBugSenseOn = new SharedPreferences(getAppContext())
				.getBoolean(PersonaConstants.IS_BUGSENSE_ON, false);
		if (isBugSenseOn) {
			PersonaBugSenseHandler bugSenseHandler = new PersonaBugSenseHandler();
			bugSenseHandler.initSession(getAppContext());
		}
	}
