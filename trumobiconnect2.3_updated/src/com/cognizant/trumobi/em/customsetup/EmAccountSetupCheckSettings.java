 ...
 */
public class EmAccountSetupCheckSettings extends TruMobiBaseActivity implements OnClickListener {
    ...
    public void onBackPressed() {
    	...
    	super.onBackPressed();
    	finishAll = true;
    	Log.e("AccountSetupCheckSettings","onBackPressed");
    	this.finish();
    	finish();
    }
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    setResult(RESULT_OK);
                    Log.v("Finishhhhhhhhh", "333333333333333333333333333333");
                    finish();
