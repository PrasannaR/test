...
/**
 * This custom View is the list item for the AccountFolderList activity, and
 * serves two purposes: 1. It's a container to store row metadata 2. It handles
 * internal clicks so we can create virtual "buttons" in the list
 */
public class EmAccountFolderListItem extends LinearLayout {

	public long mAccountId;

	private EmAccountFolderList.AccountsAdapter mAdapter;
	...
	public EmAccountFolderListItem(Context context) {
		super(context);
	}

	public EmAccountFolderListItem(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	 ...
	 */
	public void bindViewInit(EmAccountFolderList.AccountsAdapter adapter,
			boolean hasFolderButton) {
		mAdapter = adapter;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (!mCachedViewPositions) {
			...
			mFolderLeft = findViewById(R.id.folder_button).getLeft()
					- folderPadding;
