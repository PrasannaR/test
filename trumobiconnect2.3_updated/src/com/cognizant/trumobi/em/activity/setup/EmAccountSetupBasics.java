...
public class EmAccountSetupBasics extends TruMobiBaseActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.em_account_setup_basics);
        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.em_customtitlebar);

        mEmailView = (TruMobBaseEditText)findViewById(R.id.account_email);
    ...
    private void validateFields() {
        boolean valid = EmUtility.requiredFieldValid(mEmailView)
         ...
         */
        EmUtility.setCompoundDrawablesAlpha(mNextButton, mNextButton.isEnabled() ? 255 : 128);
    }
...
*/
        ...
        EmAccountSetupAccountType.actionSelectAccountType(this, mAccount, mDefaultView.isChecked(),
