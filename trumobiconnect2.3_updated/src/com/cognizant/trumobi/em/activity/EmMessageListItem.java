 ...
 */
public class EmMessageListItem extends RelativeLayout {
    ...
    private EmMessageList.MessageListAdapter mAdapter;
    ...
    public EmMessageListItem(Context context) {
        super(context);
    }

    public EmMessageListItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EmMessageListItem(Context context, AttributeSet attrs, int defStyle) {
     ...
     */
    public void bindViewInit(EmMessageList.MessageListAdapter adapter, boolean allowBatch) {
        mAdapter = adapter;
