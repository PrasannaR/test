...
public class EmIOUtils {
     ...
     * {@link EmLineIterator#close()} or {@link EmLineIterator#closeQuietly(EmLineIterator)}.
     * <p>
     ...
     */
    public static EmLineIterator lineIterator(Reader reader) {
        return new EmLineIterator(reader);
    }
     ...
     * @since Commons IO 1.2
     */
    public static EmLineIterator lineIterator(InputStream input, String encoding)
                     throws IOException {
        Reader reader = null;
        if (encoding == null) {
