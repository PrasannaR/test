...
public final class EmTrustManagerFactory {
    ...
    private static class SecureX509TrustManager implements X509TrustManager {
        ...
        public synchronized static X509TrustManager getInstance(String host) {
            ...
            if (mTrustManager.containsKey(host)) {
            	Log.d(LOG_TAG, "hey, trust manager contains the host key");
                trustManager = mTrustManager.get(host);
            } else {
            	Log.d(LOG_TAG, " trust manager doesn't contain the host key");
                trustManager = new SecureX509TrustManager(host);
                mTrustManager.put(host, trustManager);
            }

            Log.d(LOG_TAG, "Trust Manager: "+trustManager.toString());
            return trustManager;
        }
        ...
        public static String getHost() {
        	Log.d(LOG_TAG, "valid host address: "+mHost);
        	return mHost;
        }
    ...
    static {
        ...
        try {
            ...
            Context app = EmWelcome.app;
            app = Email.getAppContext();//(app == null)? EmSyncManager.getContext():app;
            //for reference commenting
    ...
    public static String getHostAddress() {
        ...
        return  SecureX509TrustManager.getHost();
    }
