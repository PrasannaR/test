 ...
 */
public class EmLoggingInputStream extends FilterInputStream {
    private StringBuilder mSb;
    private boolean mDumpEmptyLines;
    private final String mTag;

    public EmLoggingInputStream(InputStream in) {
        this(in, "RAW", false);
    }

    public EmLoggingInputStream(InputStream in, String tag, boolean dumpEmptyLines) {
        super(in);
        mTag = tag + " ";
    ...
    private void logRaw(int oneByte) {
        if (oneByte == '\r') {
            ...
            mSb.append("\\x" + EmUtility.byteToHex(oneByte));
        }
    }
