...
public abstract class EmFolder {
     ...
     *
     * Not all {@link EmFolder} implementation won't call it.
     * (Currently {@link com.cognizant.trumobi.em.mail.store.EmLocalStore.LocalFolder} won't.)
     */
     ...
     */
    public abstract void close(boolean expunge) throws EmMessagingException;
     ...
     * @return
     */
    public abstract OpenMode getMode() throws EmMessagingException;
     ...
     */
    public abstract boolean create(FolderType type) throws EmMessagingException;

    public abstract boolean exists() throws EmMessagingException;

    /**
     * @return A count of the messages in the selected folder.
     */
    public abstract int getMessageCount() throws EmMessagingException;

    public abstract int getUnreadMessageCount() throws EmMessagingException;

    public abstract EmMessage getMessage(String uid) throws EmMessagingException;

    public abstract EmMessage[] getMessages(int start, int end, MessageRetrievalListener listener)
            throws EmMessagingException;
     ...
     * @param listener
     */
    public abstract EmMessage[] getMessages(MessageRetrievalListener listener)
            throws EmMessagingException;

    public abstract EmMessage[] getMessages(String[] uids, MessageRetrievalListener listener)
            throws EmMessagingException;
    ...
    public EmMessage[] getMessages(EmFlag[] setFlags, EmFlag[] clearFlags, 
        ...
        throw new EmMessagingException("Not implemented");
    }

    public abstract void appendMessages(EmMessage[] messages) throws EmMessagingException;

    public abstract void copyMessages(EmMessage[] msgs, EmFolder folder,
            MessageUpdateCallbacks callbacks) throws EmMessagingException;

    public abstract void setFlags(EmMessage[] messages, EmFlag[] flags, boolean value)
            throws EmMessagingException;

    public abstract EmMessage[] expunge() throws EmMessagingException;

    public abstract void fetch(EmMessage[] messages, EmFetchProfile fp,
            MessageRetrievalListener listener) throws EmMessagingException;

    public abstract void delete(boolean recurse) throws EmMessagingException;

    public abstract String getName();

    public abstract EmFlag[] getPermanentFlags() throws EmMessagingException;
    ...
    public void localFolderSetupComplete(EmFolder localFolder) throws EmMessagingException {
     ...
     */
    public abstract EmMessage createMessage(String uid) throws EmMessagingException;
    ...
    public interface MessageUpdateCallbacks {
         ...
         */
        public void onMessageUidChange(EmMessage message, String newUid) throws EmMessagingException;
         ...
         * @throws EmMessagingException
         */
        public void onMessageNotFound(EmMessage message) throws EmMessagingException;
    }
