...
public abstract class EmStore {
    ...
    private static final HashMap<String, EmStore> sStores = new HashMap<String, EmStore>();
    ...
    public static EmStore newInstance(String uri, Context context, PersistentDataCallbacks callbacks)
        ...
        throw new EmMessagingException("Store.newInstance: Unknown scheme in " + uri);
    }

    private static EmStore instantiateStore(String className, String uri, Context context, 
        ...
        try {
            ...
            throw new EmMessagingException("can not instantiate Store object for " + uri);
        }
        if (!(o instanceof EmStore)) {
    ...
    public static class StoreInfo {
        ...
        public static StoreInfo getStoreInfo(String scheme, Context context) {
            StoreInfo result = getStoreInfo(R.xml.em_stores_product, scheme, context);
            if (result == null) {
                result = getStoreInfo(R.xml.em_stores, scheme, context);
            }
            return result;
        }
     ...
     * @throws EmMessagingException
     */
    public synchronized static EmStore getInstance(String uri, Context context, 
            PersistentDataCallbacks callbacks)
        throws EmMessagingException {
        EmStore store = sStores.get(uri);
        if (store == null) {
        ...
        if (store == null) {
            throw new EmMessagingException("Unable to locate an applicable Store for " + uri);
        }
    ...
    public Class<? extends android.app.Activity> getSettingActivityClass() {
        ...
        return com.cognizant.trumobi.em.activity.setup.EmAccountSetupIncoming.class;
    }
    ...
    public abstract EmFolder getFolder(String name) throws EmMessagingException;

    public abstract EmFolder[] getPersonalNamespaces() throws EmMessagingException;
    
    public abstract void checkSettings() throws EmMessagingException;
    
    /**
     * Delete Store and its corresponding resources.
     * @throws EmMessagingException
     */
    public void delete() throws EmMessagingException {
    }
