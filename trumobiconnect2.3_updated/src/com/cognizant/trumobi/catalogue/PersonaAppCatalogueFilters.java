...
public final class PersonaAppCatalogueFilters {

	private static PersonaAppCatalogueFilters sInstance;

	public synchronized static PersonaAppCatalogueFilters getInstance() {
        if (sInstance == null) {
        	sInstance = new PersonaAppCatalogueFilters();
        }
        return sInstance;
    }
	...
	private final PersonaAppCatalogueFilter mDrawerFilter = new PersonaAppCatalogueFilter();
	...
	private PersonaAppCatalogueFilters() {}

	public PersonaAppCatalogueFilter getDrawerFilter() {
	...
	public List<Integer> getGroupsAndSpecialGroupIndexes() {
		...
		result.add(PersonaAppGroupAdapter.APP_GROUP_ALL);
