...
public class PersonaScreensAdapter extends BaseAdapter {
	    private Context mContext;
	    private float mWidth;
	    private float mHeight;
	    private ArrayList<PersonaCellLayout> mScreens;

	    public PersonaScreensAdapter(Context c,int width,int height) {
	        mContext = c;
	        mWidth=width/1.6f;
	        mHeight=height/1.6f;
	    }
	    public void addScreen(PersonaCellLayout screen){
	    	if(mScreens==null)
	    		mScreens=new ArrayList<PersonaCellLayout>();
	    	mScreens.add(screen);
	    	notifyDataSetChanged();
	    }
	    public void addScreen(PersonaCellLayout screen, int position){
	    	if(mScreens==null)
	    		mScreens=new ArrayList<PersonaCellLayout>();
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
        	...
        	if(convertView==null){
        		...
        		((ImageView)convertView).setBackgroundResource(R.drawable.pr_preview_bg);
        	}
    		if(b!=null){
