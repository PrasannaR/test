...
public class PersonaDialogSeekBarPreference extends DialogPreference implements
    ...
    public PersonaDialogSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        setPersistent(true);
        ...
        setDialogLayoutResource(R.layout.pr_my_seekbar_preference);
    }
