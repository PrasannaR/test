...
//import com.cognizant.trumobi.persona.launcher.catalogue.CataGridView;
...
public class PersonaAllAppsGridView extends GridView implements
		AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener,
		PersonaDragSource, PersonaDrawer {
	...
	public PersonaAllAppsGridView(Context context) {
		super(context);
	}

	public PersonaAllAppsGridView(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.gridViewStyle);
	}

	public PersonaAllAppsGridView(Context context, AttributeSet attrs, int defStyle) {
...
//		mLabelPaint.setDither(false);
	...
	public void onItemClick(@SuppressWarnings("rawtypes") AdapterView parent, View v, int position, long id) {
		PersonaApplicationInfo app = (PersonaApplicationInfo) parent
	...
	public boolean onItemLongClick(AdapterView<?> parent, View view,
		...
		PersonaLog.d("Persona PersonaLauncher","onItemLongClick");
		PersonaApplicationInfo app = (PersonaApplicationInfo) parent
				.getItemAtPosition(position);
	...
	public void setLauncher(PersonaLauncher personaLauncher) {
		...
		setSelector(PersonaIconHighlights.getDrawable(mLauncher,
				PersonaIconHighlights.TYPE_DESKTOP));
	}
	...
	public void open(boolean animate) {
		...
		mDrawLabels = PersonaAlmostNexusSettingsHelper.getDrawerLabels(mLauncher);
		mFadeDrawLabels = PersonaAlmostNexusSettingsHelper
	...
	public void updateAppGrp() {
		if(getAdapter()!=null){
			((PersonaApplicationsAdapter) getAdapter()).updateDataSet();
		}
	}
